...
By adding mercury to the open end of the tube, which adds pressure to the air on the sealed side. The higher the pressure the lower the volume and vice versa. 
\end{solution}
...
\begin{solution}
\[P_1V_1=P_2V_2\]
$P_1$ is the initial pressure, $V_1$ is the initial volume. $P_2$ is the final pressure, $V_2$ is the final volume. Their products are equivalent in a closed system. 
\end{solution}
...
\end{custom-big}
\begin{solution}\\
The standard unit for pressure is Pa $=$ N/m$^2=$ kg/ms$^2$.\\
The standard unit for volume is L $=$ 0.001 m$^3$.
\end{solution}
...
\begin{align*}
    P_1V_1&=P_2V_2\\
    V_2&=\frac{10.6\text{ L}\cdot 30.0\text{ mmHg}}{70.0\text{ mmHg}}\\
    V_2&=4.54\text{ L}
\end{align*}
\end{solution}
...
\begin{align*}
    P_1V_1&=P_2V_2\\
    V_2&=\frac{0.70\text{ mmHg}}{0.25\text{ mmHg}}\cdot 0.3786\text{ L}\\
    V_2&=1.1\text{ L}
\end{align*}
\end{solution}
...
\begin{align*}
    P_1V_1&=P_2V_2\\
    1.00\text{ atm}\cdot 10.0\text{ L}&=P_2\cdot 3.00\text{ L}\\
    P_2&=3.33\text{ atm}
\end{align*}
\end{solution}
...
\begin{align*}
    P_1V_1&=P_2V_2\\
    1\text{ atm}\cdot 5\text{ L}&= 3.5\text{ atm} \cdot V_2\\
    V_2&=1.4\text{ L}
\end{align*}
\end{solution}
...
\begin{align*}
    P_1V_1&=P_2V_2\\
    24.5\text{ mmHg}\cdot 300\text{ mL}&=P_2\cdot 250\text{ mL}\\
    P_2&=29.4\text{ mmHg}\\
    \Delta P&=29.4-24.5=4.9\text{ mmHg}
\end{align*}
\end{solution}


\begin{custom-big}[Example 10]
A sealed pot has volume of 4.0 L, 3.5 L of it is water, the rest is steam with pressure of 2.0 atm. 0.50 L of water is boiled into steam. Assume the volume of 1 atm steam is 10.0 times the volume of water with the same moles of water molecules. What is the pressure of steam after boiling?
\end{custom-big}
\begin{solution}
From Boyle's Law:
\begin{align*}
    P_1V_1&=P_2V_2\\
    2.0\text{ atm}\cdot 0.5\text{ L}&=1.0\text{ atm}\cdot V_2\\
    V_2&=1.0\text{ L}
\end{align*}
Therefore the initial steam inside the pot is equivalent to 1.0 L of 1.0 atm of steam. $0.50\text{ L}\times 10=5.0\text{ L}$ of 1.0 atm steam is generated after boiling. That gives a total of 1.0 L + 5.0 L = 6.0 L of 1.0 atm steam, which is compressed in a space of $4.0\text{ L}-(3.5\text{ L}-0.5\text{ L})=1.0\text{ L}$ of space. Apply Boyle's Law again,
\begin{align*}
    P_1V_1&=P_2V_2\\
    1.0\text{ atm}\cdot 6.0\text{ L}&=P_2\cdot 1.0\text{ L}\\
    P_2&=6.0\text{ atm}
\end{align*}
\end{solution}
...
\begin{align*}
    P_1V_1&=P_2V_2\\
    2.0\text{ atm}\cdot 3.0\text{ L}&=P_2\cdot (3.0\text{ L}+2.0\text{ L})\\
    P_2&=1.2\text{ atm}\\
    3.0\text{ atm}\cdot 2.0\text{ L}&=P_2\cdot (3.0\text{ L}+2.0\text{ L})\\
    P_2&=1.2\text{ atm}
\end{align*}
Add them up! $1.2\text{ atm}+1.2\text{ atm}=2.4\text{ atm}$
\end{solution}
...
\end{custom-big}
\begin{solution}
From Dalton's Law, we need 3.7 L of  $2.0-1.3=0.7$ atm of air. Convert this amount of air to 1 atm,
\begin{align*}
    P_1V_1&=P_2V_2\\
    0.7\text{ atm}\cdot 3.7\text{ L}&=1\text{ atm}\cdot V_2\\
    V_2&=2.6\text{ L}
\end{align*}
\end{solution}
